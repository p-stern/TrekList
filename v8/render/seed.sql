...
(7480, 'DIS', 'Star Trek: Discovery', 'TV', 5, 8),
...
(48090, 'SNW', 'Star Trek: Strange New Worlds', 'TV', 4, 13),
(60302, 'SA', 'Star Trek: Starfleet Academy', 'TV', 1, 14);
...
INSERT INTO title
  (id, abbr, premiered_date, media_id, season_id, episode_id, episode_num_sort, title, summary)
VALUES
  (1, 'Movie', '1979-12-07', 1, 1, '1', 1, 'Star Trek: The Motion Picture', ' '),
  (2, 'Movie', '1982-06-04', 1, 1, '2', 2, 'Star Trek II: The Wrath of Khan', ' '),
  (3, 'Movie', '1984-06-01', 1, 1, '3', 3, 'Star Trek III: The Search for Spock', ' '),
  (4, 'Movie', '1986-11-26', 1, 1, '4', 4, 'Star Trek IV: The Voyage Home', ' '),
  (5, 'Movie', '1989-06-09', 1, 1, '5', 5, 'Star Trek V: The Final Frontier', ' '),
  (6, 'Movie', '1991-12-06', 1, 1, '6', 6, 'Star Trek VI: The Undiscovered Country', ' '),
  (7, 'Movie', '1994-11-18', 1, 2, '1', 1, 'Star Trek Generations', ' '),
  (8, 'Movie', '1996-11-22', 1, 2, '2', 2, 'Star Trek: First Contact', ' '),
  (9, 'Movie', '1998-12-11', 1, 2, '3', 3, 'Star Trek: Insurrection', ' '),
  (10, 'Movie', '2002-12-13', 1, 2, '4', 4, 'Star Trek Nemesis', ' '),
  (11, 'Movie', '2009-05-08', 1, 3, '1', 1, 'Star Trek', ' '),
  (12, 'Movie', '2013-05-16', 1, 3, '2', 2, 'Star Trek Into Darkness', ' '),
  (13, 'Movie', '2016-07-22', 1, 3, '3', 3, 'Star Trek Beyond', ' '),
  (14, 'Movie', '2025-01-24', 1, 4, '1', 1, 'Star Trek: Section 31', ' ');
...
CREATE INDEX premiered_index ON title (premiered_date, season_id, episode_num_sort);
